    ...
    return (
        ...
        >
            ...
            <PopoverPanel anchor="top"
                className="z-60 fixed bottom-0 right-0 top-0 flex max-w-md flex-col bg-white w-112">
                <div
                    ...
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" aria-hidden="true" data-slot="icon" className="h-7 w-7">
